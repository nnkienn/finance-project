...
import com.finance.finance.user.dto.AuthResponse;
import com.finance.finance.user.dto.ChangePasswordRequest;
import com.finance.finance.user.dto.LoginRequest;
import com.finance.finance.user.dto.RegisterRequest;
...
import com.finance.finance.user.repository.EmailVerificationTokenRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest req) {
        ...
        var roleUser = roleRepository.findByName("ROLE_USER")
                .orElseGet(() -> roleRepository.save(new com.finance.finance.user.entity.Role(null, "ROLE_USER")));
