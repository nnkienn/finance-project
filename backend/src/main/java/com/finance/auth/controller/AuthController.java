...
public class AuthController {
	...
	public ResponseEntity<?> login(@Valid @RequestBody LoginRequest req, HttpServletResponse res) {
		try {
			...
			return ResponseEntity
					.ok(new AuthResponse("Bearer", accessToken, jwtService.getAccessTokenValiditySeconds()));
	...
	public ResponseEntity<?> refreshToken(@CookieValue(name = "refresh_token", required = false) String refreshToken) {
		...
		return ResponseEntity.ok(new AuthResponse("Bearer", newAccess, jwtService.getAccessTokenValiditySeconds()));
	}
